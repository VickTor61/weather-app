class WeatherService
  ...
  def fetch_weather
    ...
    weather_data = self.class.get("/data/3.0/onecall", query: { lat: lat, lon: lon, exclude: "minutely,alerts", units: "metric", appid: @api_key }).parsed_response
  ...
  def get_coordinates
    response = self.class.get("/geo/1.0/direct", query: { q: @city, limit: 1, appid: @api_key }).parsed_response
